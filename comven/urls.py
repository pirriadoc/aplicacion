...
urlpatterns = [
    ...
    url(r'^juego/crear/$', login_required(CrearJuego.as_view()), name='crear1'),
    url(r'^juego/(?P<pk>[0-9]+)/actualizar/$', login_required(ActualizarJuego.as_view()), name='actualizar1'),
    url(r'^juego/(?P<pk>[0-9]+)/borrar/$', login_required(BorrarJuego.as_view()), name='borrar1'),
